 ...
 */
public class MyJettyLauncher extends ServletContainerLauncher {

	public static final String[] DEFAULT_CONFIG_CLASSES = {
			"org.mortbay.jetty.webapp.WebInfConfiguration", // init webapp
															// structure
			"org.mortbay.jetty.plus.webapp.EnvConfiguration", // process
																// jetty-env
			"org.mortbay.jetty.plus.webapp.Configuration", // process web.xml
			"org.mortbay.jetty.webapp.JettyWebXmlConfiguration", // process
																	// jetty-web.xml
	};
